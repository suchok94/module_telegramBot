...
from keyboards import get_feedback_keyboard, get_scores_keyboard
...
async def start_handler(message: types.Message):
    await message.answer('Привет, я создан для сбора обратной связи.\n'
                         'Чтобы оставить сообщение, необходимо ввести команду \n/feedback\n'
                         'или нажать на кнопку "Оставить отзыв" ниже.', reply_markup=get_feedback_keyboard())
    await message.answer(f'Для просмотра отзывов напиши \n/show\n'
                         f'или нажми на кнопку "Покажи отзывы" ниже. ')
